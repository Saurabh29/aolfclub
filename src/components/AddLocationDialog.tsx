...
export default function AddLocationDialog(props: AddLocationDialogProps) {
  ...
  const handleSave = async () => {
    if (!isValid()) {
      alert(
        "Please provide a valid Location ID (6-50 characters, lowercase letters, numbers, and hyphens) and Location Name (minimum 2 characters)",
      );
      return;
    }
      ...
      <DialogContent class="sm:max-w-[600px] bg-white">
        ...
        <div class="space-y-4 py-4">
          ...
          <div>
            ...
            <p class="text-xs text-gray-500 mt-1">
              <Show when={!isEditing()}>
                Unique identifier for URL (6-50 characters, lowercase letters,
        ...
        <div class="flex items-center justify-end gap-3 pt-4 border-t border-gray-200">
          ...
          <Button onClick={handleSave} disabled={!isValid() || saving()}>
            <Show
              when={saving()}
              fallback={
                props.editingLocation ? "Update Location" : "Save Location"
              }
            >
              Saving...
            </Show>
