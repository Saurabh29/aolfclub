 ...
 * 
 * A self-contained authentication dropdown that displays sign-in options
 * for multiple OAuth providers using solid-ui's DropdownMenu component.
 * 
 * Features:
 * - Toggle dropdown via profile icon
 * - Built-in click-outside to close (from solid-ui)
