  ...
  return (
    ...
    >
      ...
      <div class="flex items-start justify-between mb-2">
        ...
        <span class={cn("w-2 h-2 rounded-full ml-2 mt-1", props.getPriorityColor(props.task.priority))} />
      </div>
      ...
      <div class="flex items-center gap-1 text-xs text-gray-600 mb-2">
        ...
        <span class="truncate">{props.getUserNames(props.task.assignedTo)}</span>
      </div>
      ...
      <div class={cn(
        ...
        props.isOverdue(props.task.dueDate) ? "text-red-600" : "text-gray-600"
      )}>
        <svg class="h-3 w-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
