...
import { PROGRAMS, type User, type UserRole } from "~/lib/schemas/user.schema";
 ...
 * - Updates user instead of creating new
 */
...
export default function EditUserPage() {
  ...
  const loadUser = async () => {
    ...
    try {
      ...
      setPhone(data.phone);
      setRole(data.role);
      setProgramsDone(data.programsDone || []);
      setProgramsWant(data.programsWant || []);
      setEnableLogin(data.enableLogin);
    } catch (error) {
        ...
        >
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Update the details below to modify this user account
              </CardDescription>
            </CardHeader>
            <CardContent>
