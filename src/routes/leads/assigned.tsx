      ...
      <CardContent class="space-y-3 sm:space-y-4 px-4 pb-4">
        ...
        <div class="space-y-1.5 sm:space-y-2 text-sm">
          ...
          <div class="flex items-center gap-3 flex-wrap">
            <div class="flex items-center gap-1.5 sm:gap-2">
              <svg class="h-4 w-4 text-gray-400 sm:text-gray-500 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" />
              </svg>
              <Badge variant="secondary" class={cn("text-xs px-2 py-0.5", getSourceColor(props.lead.leadSource))}>
            ...
            <div class="flex items-center gap-1.5 sm:gap-2">
              ...
              <span class="text-gray-600 text-xs sm:text-sm">Last: {formatDate(props.lead.lastContact)}</span>
            </div>
          </div>
          ...
          <Show when={props.lead.nextFollowUp}>
            <div class="flex items-center gap-2 bg-blue-50 -mx-4 px-4 py-2 rounded-lg">
              ...
              <span class="text-blue-700 font-medium text-xs sm:text-sm">Follow-up: {formatDate(props.lead.nextFollowUp!)}</span>
            </div>
          </Show>
        </div>
        ...
        <div class="grid grid-cols-3 sm:flex sm:items-center gap-2 sm:gap-3 pt-2">
          ...
          <a href={`tel:${props.lead.phone}`} class="block sm:flex-1">
            <Button variant="outline" size="default" class="w-full h-12 sm:h-11 flex flex-col sm:flex-row items-center justify-center gap-1 sm:gap-2 active:bg-gray-100">
          ...
          {/* WHATSAPP Button */}
          <a href={getWhatsAppUrl()} target="_blank" rel="noopener noreferrer" class="block sm:flex-1">
            <Button variant="outline" size="default" class="w-full h-12 sm:h-11 flex flex-col sm:flex-row items-center justify-center gap-1 sm:gap-2 text-green-600 border-green-300 hover:bg-green-50 active:bg-green-100">
          ...
          {/* DETAILS Button */}
          <Button variant="default" size="default" class="h-12 sm:h-11 sm:px-6 flex flex-col sm:flex-row items-center justify-center gap-1 sm:gap-0 active:bg-primary/90">
            ...
            <span class="text-xs sm:text-sm font-medium hidden sm:inline">DETAILS</span>
          </Button>
        </div>
      </CardContent>
    </Card>
    ...
    <div class="min-h-screen bg-gray-50 pb-6">
      ...
      <header class="bg-white border-b border-gray-200 sticky top-0 z-10 shadow-sm">
        <div class="px-4 py-4 sm:max-w-3xl sm:mx-auto sm:px-6 lg:px-8 sm:py-6">
          <h1 class="text-xl sm:text-2xl font-bold text-gray-900">Assigned Leads</h1>
      ...
      <main class="px-3 py-4 sm:max-w-3xl sm:mx-auto sm:px-6 lg:px-8 sm:py-6">
        ...
        <div class="mb-4 sm:mb-6 flex items-center gap-2 overflow-x-auto pb-2 -mx-3 px-3 sm:mx-0 sm:px-0 scrollbar-hide">
          <Button variant="outline" size="sm" class="flex-shrink-0 h-9">All</Button>
          <Button variant="outline" size="sm" class="flex-shrink-0 h-9">Walk-in</Button>
          <Button variant="outline" size="sm" class="flex-shrink-0 h-9">Referral</Button>
          <Button variant="outline" size="sm" class="flex-shrink-0 h-9">Campaign</Button>
          <div class="w-px h-6 bg-gray-300 flex-shrink-0" />
          <Button variant="outline" size="sm" class="flex-shrink-0 h-9">5 ⭐</Button>
          <Button variant="outline" size="sm" class="flex-shrink-0 h-9">4+ ⭐</Button>
        </div>
              ...
              <Card class="shadow-sm">
                <CardContent class="py-16 sm:py-12">
                  <div class="text-center text-gray-500">
                    ...
                    <p class="text-base sm:text-lg font-medium">No leads assigned</p>
