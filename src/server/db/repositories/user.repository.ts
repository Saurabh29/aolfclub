...
import type { User, UserType } from "~/lib/schemas/domain";
...
export async function updateUser(
  ...
  const fields = [
    "displayName", "userType", "isAdmin", "image", "phone",
    "activeLocationId", "memberSince", "programsDone", "interestedPrograms",
    "lastCallDate", "lastInterestLevel", "nextFollowUpDate", "lastNotes", "totalCallCount",
  ] as const;
